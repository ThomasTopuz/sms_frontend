...
const SchoolClassesPage = (props: any) => {
    ...
    // api call
    useEffect(() => {
        axios.get(`${BASE_URL}/schoolclass`)
    ...
    return (
        <BoxedPage>
                <div className={"row m-0 mt-2  justify-content-between"}>
                    ...
                    <IconButton className={"btn-success"}
                ...
                </div>
                {
                    isModalOpen 
                    &&
                    <CreateSchoolClassModal onSubmit={(data)=>console.log(data)}/>
                }
